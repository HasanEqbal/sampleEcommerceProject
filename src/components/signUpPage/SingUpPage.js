      ...
      return (
        ...
        >
          ...
          <p className="h5 text-center mb-4">Sign up</p>
            ...
            <Field name="displayName" component={this.renderInput} lable="First Name"/>
            <Field name="lastName" component={this.renderInput } lable="Last Name"/>
            <Field name="email" component={this.renderInput} lable="Email Address"/>
            <Field name="password" component={this.renderInput } lable="Password"/>
            <MDBBtn className="text-center" type="submit">Sign Up</MDBBtn>
            </form>
        );
        }
    }
